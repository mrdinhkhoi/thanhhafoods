...
<p class="form-field form-field-wide form-field-type-' . $btn['type'] . '">
	<strong>'.wooccm_wpml_string( trim( $btn['label'] ) ).':</strong><br />' . nl2br( get_post_meta( $order->id , $btn['cow'], true ) ) . '
</p>
<!-- .form-field-type-... -->';
			} elseif(
				!empty( $btn['label'] ) && 
		...
		foreach( $buttons as $btn ) {
			if( !in_array( $btn['cow'], $fields ) ) {
				if(
					...
					echo '
<p class="form-field form-field-wide form-field-type-' . $btn['type'] . '">
	<strong>'.wooccm_wpml_string( trim( $btn['label'] ) ).':</strong><br />'.nl2br( get_post_meta( $order->id , '_billing_'.$btn['cow'], true ) ).'
</p>
<!-- .form-field-type-... -->';
				} elseif( 
					!empty( $btn['label'] ) && 
		...
		foreach( $buttons as $btn ) {
			...
			if( !in_array( $btn['cow'], $fields ) ) {
				if(
					...
					echo '
<p class="form-field form-field-wide form-field-type-' . $btn['type'] . '">
	<strong>'.wooccm_wpml_string( trim( $btn['label'] ) ).':</strong><br />'.nl2br( get_post_meta( $order->id , '_shipping_'.$btn['cow'], true ) ).'
</p>
<!-- .form-field-type-... -->';
				} elseif(
					!empty( $btn['label'] ) && 
