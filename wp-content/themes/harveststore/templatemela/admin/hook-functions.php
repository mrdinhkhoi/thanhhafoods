...
function harvest_custom_css() { do_action( 'harvest_custom_css' ); }      
add_action('harvest_custom_css', 'templatemela_id14', 20);
if ( ! function_exists( 'templatemela_id14' ) ) {
  function templatemela_id14() {  
    echo '<style>'.stripslashes(get_option('templatemela_custom_css')).'</style>';
  }
}